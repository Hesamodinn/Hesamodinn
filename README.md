...
2. **license-plate-detection-detectron2** — RetinaNet fine-tuned for license plate detection. AP 81.6 / AP50 96.9 / AP75 89.2. *PyTorch, Detectron2*
3. **cv-parser** — Document parser with LLM extraction and schema-validated output. *C#, .NET*
4. **label-scanner** — On-device barcode/OCR scanner, no server round-trip. *JavaScript, WebAssembly, PWA*

### Stack
C# · .NET 8 · ASP.NET Core · Blazor · Python · OpenCV · PyTorch · TensorFlow · AWS · SQL Server · Docker

[LinkedIn](https://www.linkedin.com/in/hesam-fathollahi/) · hesamodin.f@gmail.com
